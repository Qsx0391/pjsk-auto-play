...
private:
    ...
    inline static const std::string kInputEventTouchDown =
        "nemu_input_event_touch_down";
    inline static const std::string kInputEventTouchUp =
        "nemu_input_event_touch_up";
    inline static const std::string kInputEventKeyDown =
        "nemu_input_event_key_down";
    inline static const std::string kInputEventKeyUp =
    ...
    std::function<decltype(nemu_input_event_touch_down)>
        input_event_touch_down_func_;
    std::function<decltype(nemu_input_event_touch_up)>
        input_event_touch_up_func_;
    std::function<decltype(nemu_input_event_key_down)>
